...
class Upload{
	...
	public Upload(final Editor editorin, final Path pathos, JPanel card2, String[] listadata, boolean updatecheck) throws IOException, TransportException, GitAPIException
	{
            	...
            	Editor editor = editorin.getBase().getActiveEditor();
            	 ...
            	 if(a1.contains("Name your shader")||b1.contains("Write some tags about your shader")||c1.contains("Write a small description")
            		 ...
            		 JOptionPane.showMessageDialog(null,
            				     "Please fill the form it will take few minutes"
            				 , //Mensaje
            				 	    "Fill the form", //Title
                	...
                	//Image Load
                	 ...
                	 if (selectedOption1 == JOptionPane.YES_OPTION) {
            			...
            			/* 
            			 //Option if you want to add default image if cancelled
            			 //after selecting any image
            			 
            			 //Known Bug FileChooser if cancelled and no selection then event Null
            			 //does not affect the program just breaks it and you need to decide if
            			 //using an image or the default one   
                    ...
                    */
             		...
             		///// PDE AND DATA CHECK
                		...
                		try {
               			...
               			maintab = sketch.getName();
               			sketchfolder = sketch.getFolder();
               			...
               			SketchCode[] prueba1 = sketch.getCode();
               			String prueba2 = prueba1[0].getProgram().toString();
               			String prueba3 = sketch.getCode(0).getProgram();
               			String prueba4 = prueba1[0].getProgram();
               			...
               			String prueba5 = prueba1[0].getProgram();
               			String prueba6 = prueba1[1].getProgram();
               			String prueba7 = prueba1[1].getFileName();
          ...
          //PDE CHECK
           ...
           if(pdecode.contains("PShader")){
			  ...
			  try {
         	  ...
         	  Path pathtab = Paths.get(repo+"/ShaderData/"+a1+"/Tabs"); 
         	 
         	  if(Files.exists(pathtab)){
         	   
         	   File dirdata2 = new File(repo+"/ShaderData/"+a1+"/Tabs");
               String[] dirdatainfo2 = dirdata2.list();
         	   
         	   for (int x=0;x<dirdatainfo2.length;x++){
				 	
        		   try {
						git.rm()
						.addFilepattern("ShaderData/"+a1+"/Tabs/"+ dirdatainfo2[x])
						.call();
					} catch (NoFilepatternException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
